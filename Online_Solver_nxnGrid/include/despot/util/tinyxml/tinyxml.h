...
#ifndef DESPOT_UTIL_TINYXML_INCLUDED
#define DESPOT_UTIL_TINYXML_INCLUDED
...
// Deprecated library func hell. Compilers want to use the
...
//#pragma message( "Using _sn* funcs." )
#define TIXML_SNPRINTF _snprintf
#define TIXML_SNSCANF  _snscanf
#define TIXML_SSCANF   sscanf
#elif defined(__GNUC__) && (__GNUC__ >= 3 )
// GCC version 3 and higher.s
//#warning( "Using sn* funcs." )
...
// Only used by Attribute::Query funcs
enum {
...
/** TiXmlBase is a base class for every class in TinyXml.
 ...
 can be printed and provide some utility funcs.
...
public:
	...
	/**	The world does not agree on whether white space should be kept or
	 not. In order to make everyone happy, these global, static funcs
	...
	inline static const char* GetChar(const char* p, char* _value, int* length,
		...
		if (*length == 1) {
			...
			*_value = *p;
			...
			//strncpy( _value, p, *length );	// lots of compilers don't like this func (unsafe),
...
public:
	...
	/** The meaning of 'value' changes for the specific type of
	 ...
	 The subclasses will wrap this func.
	 */
	...
	/** Add a new node related to this. Adds a child past the LastChild.
	 ...
	 uses a different memory model than the other insert funcs.
	...
	/** Convenience func to get through elements.
...
protected:
	...
	// Copy to the allocated object. Shared funcality between Clone, Copy constructor,
...
public:
	...
	/** Convenience func for easy access to the text inside an element. Although easy
	 ...
	 Note that this func can be misleading. If the element foo was created from
	 this XML:
	 @verbatim
...
public:
	...
	/** Generally, you probably want the error string ( ErrorDesc() ). But if you
	 prefer the ErrorId, this func will fetch it.
	 */
	int ErrorId() const {
		return errorId;
	}
	...
	/** SetTabSize() allows the error reporting funcs (ErrorRow() and ErrorCol())
...
/** Print to memory funcality. The TiXmlPrinter is useful when you need to:
